...
<div class="hero-wrap hero-bread" style="background-image: url('<?php echo get_theme_uri('images/Jajanan Anira (1).png'); ?>');">
    <div class="container">
      <div class="row no-gutters slider-text align-items-center justify-content-center">
        <div class="col-md-9 ftco-animate text-center">
          ...
          <h1 class="mb-0 bread" style="color: #B2CD42;">Keranjang Belanja Saya</h1>
        </div>
      </div>
    </div>
  </div>
  ...
  <section class="ftco-section ftco-Keranjang Belanja">
          ...
          <?php else : ?>
            <div class="row">
              <div class="col-md-12 ftco-animate">
                <div class="alert alert-info">Tidak ada barang dalam keranjang.<br><?php echo anchor('#produk', 'Jelajahi produk kami'); ?> dan mulailah berbelanja!</div>
              </div>
            </div>
          <?php endif; ?>
          </div>
