    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
            <div class="col-md-9 ftco-animate text-center">
                <p class="breadcrumbs"><span class="mr-2" style="color: #B2CD42;"><?php echo anchor(base_url(), 'Home'); ?></span></p>
                <h1 class="mb-0 bread" style="color: #B2CD42;">Tentang Kami</h1>
            </div>
        </div>
    </div>
</div>
          ...
          <div class="container">
              <div class="row">
                  <div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(<?php echo get_theme_uri('images/about.jpg'); ?>);">
                      <a href="https://youtube.com/shorts/fSWgIZ4yQtI?si=4gGJXyCoUkfAYb9u" class="icon popup-vimeo d-flex justify-content-center align-items-center">
											<span class="icon-play"></span>
											<iframe width=600" height="400" src="https://www.youtube.com/embed/fSWgIZ4yQtI" title="Tentang Kami" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                      </a>
                  </div>
