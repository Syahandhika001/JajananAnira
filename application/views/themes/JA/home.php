...
<section id="home-section" class="hero">
    <div class="container">
        <div class="row">
            <div class="row slider-text justify-content-left align-items-center" style="padding: 120px 10px 100px 20px;" data-scrollax-parent="true">
                <div class="col-md-6">
                    <img src="<?php echo base_url('assets/themes/ja/images/Logo Buat Home Page.png'); ?>" alt="Logo" style="max-width: 70%;">
                </div>
                <div class="col-md-6 ftco-animate text-left">
                    <h1 class="mb-3" style="font-weight: bold;">Rajanya Pedas</h1>
                    <h6 class="subheading mb-4">Cemilan dengan Aroma Khas Daun Jeruk</h6>
...
<section class="ftco-section" id="products">
  ...
  <div class="container">
    ...
    <div class="col-md-12 heading-section text-center ftco-animate">
        <span class="subheading">Katalog</span>
  ...
  <section class="ftco-section img" style="background-image: url(<?php echo get_theme_uri('assets\themes\JA\images\Makaroni Bantat.jpg'); ?>);">
